...
public class s2 extends JPanel{
    ...
    public s2(Date date, String format, int defaultStartDAY2) {
		// TODO Auto-generated constructor stub
	}

	private void s2(java.util.Date date, String format, int startDAY){
    ...
    public static s2 getInstance(java.util.Date date, String format){
        return new s2(date, format, defaultStartDAY);
    }

    public static s2 getInstance(java.util.Date date){
        return getInstance(date, DEFAULTFORMAT);
    }
    public static s2 getInstance(String format){
    ...
    private class LabelManager {
        ...
        public LabelManager(){
            list = new ArrayList<s2.DayLabel>();
        }
